    ...
    return (
        <div className="about-me">
            <p className="body-para">
                Creative and user-focused front-end developer with 3+ years of experience building responsive
                web applications using React. Passionate about crafting seamless UI/UX through a sharp eye for 
            ...
            < br />
                ...
                solutions on tight deadlines. With a lifelong fascination for technology and aptitude for putting 
                users first, excited to grow technical and interpersonal skills to build the front-end of the future 
                in a quality-driven team.
            </p>
        </div>
    )
}